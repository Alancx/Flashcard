...
class OfflineCashierController extends BaseController{
	...
	public function getpro(){
		...
		$result=array();
		if ($pro=$this->model->table('RS_ProductList pl')->join("LEFT JOIN RS_Product p ON pl.ProId=p.ProId")->where("pl.ProIdInputCard='%s' and IsDelete=%d",array($barcode,0))->field("p.ProName+'_'+pl.ProSpec1 as ProName,pl.ProIdInputCard as barcode,pl.Price as price,pl.ProIdCard,pl.ProId,pl.ProSpec1+'_'+pl.ProSpec2+'_'+pl.ProSpec3 as Spec")->find()) {
