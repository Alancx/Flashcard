...
class AuthController extends CommonController{
	...
	public function distribute(){
		$roots=$this->MSL('menu')->where("Grade=1 and MenuType='store'")->select();
		$sons=$this->MSL('menu')->where("Grade=2 and MenuType='store'")->select();
		$ssons=$this->MSL('menu')->where("Grade=3 and MenuType='store'")->select();
