      ...
      <div class="ibox-content">
        <div class='row'>
          <div class='col-md-6 col-lg-6'>
            <form id='fs' method='post' action="<?php echo U('Products/savecoupons');?>">
              <div class="form-group">
                <label for="">优惠券类型</label>
                <select name="CouponType" id="CouponType" class='form-control'>
                  <option value="">请选择</option>
                  <option value="0" <?php if($info['Type'] == '0'): ?>selected='selected'<?php endif; ?>>现金抵扣券</option>
                  <!-- <option value="1" <?php if($info['Type'] == '1'): ?>selected='selected'<?php endif; ?>>满减了</option> -->
                </select>
              </div>
              <div class="form-group">
 ...
 -->              <input type="hidden" name="oldid" value="<?php echo ($info["ID"]); ?>">
          ...
          <div class='col-md-6 col-lg-6'>
            <div class='card'>
              ...
              <div class='card_rules'><?php if($info['Type'] == '0'): ?>平台商品使用立减<?php echo ($info["Rules"]); ?>元<?php endif; ?></div>
