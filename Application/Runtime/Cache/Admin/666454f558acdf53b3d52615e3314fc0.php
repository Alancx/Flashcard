                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <div class="checkbox">
                                              <label>
                                                <input type="checkbox" value="1" name="IsLeader" <?php if ($info['IsLeader']=='1'): ?>
                                                    checked="true"
                                                <?php endif ?> id="IsLeader">
                                                管理层请勾选
                                              </label>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <div class="checkbox">
                                              <label>
                                                <input type="checkbox" value="1" name="IsServer" <?php if ($info['IsServer']=='1'): ?>
                                                    checked="true"
                                                <?php endif ?> id="IsServer">
                                                客服请勾选
                                              </label>
                                            </div>
                                        </div>
