			...
			<table class="table table-condensed table-bordered table-hover">
				...
				<tbody id="tbody">
					<?php if(is_array($mers)): foreach($mers as $key=>$mb): ?><tr>
							...
							<td><?php echo ($mb["couponCount"]); ?></td>
							<td><?php echo ($mb["RegisterDate"]); ?></td>
							<td>
								<a class="btn btn-white btn-xs showorder" data-member='<?php echo ($mb["ID"]); ?>'>查看卡券详情</a>
...
$(document).ready(function(){
	...
	$('.edit').click(function(){
		...
		art.dialog.open('<?php echo U('Users/show');?>?id='+id,{width:600,height:800});
	})
	$('.showorder').click(function(){
		art.dialog.open('<?php echo U('Users/showcoupons');?>?id='+$(this).attr('data-member'),{width:800,height:600});
	})
