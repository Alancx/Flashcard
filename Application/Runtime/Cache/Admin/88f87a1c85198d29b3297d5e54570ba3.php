				...
				<tbody id="tbody">
					<?php if(is_array($mers)): foreach($mers as $key=>$mb): ?><tr>
							...
							<td>
								...
								<a class="btn btn-warning btn-xs edit" data-member='<?php echo ($mb["ID"]); ?>'>查看</a>
							</td>
...
$(document).ready(function(){
	...
	$('.showorder').click(function(){
		art.dialog.open('<?php echo U('Users/showorders');?>?MemberId='+$(this).attr('data-member'),{width:600,height:800});
	})
