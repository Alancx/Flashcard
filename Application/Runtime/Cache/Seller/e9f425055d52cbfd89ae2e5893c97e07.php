  ...
  <body>
    <div class="container" style="width:100%!important;" id="content">
      <div class="row">
        ...
        <div class="col-xs-12" style="font-size: 15px;"><b>就餐码：<?php echo ($oinfo["ShortOid"]); ?></b></div>
        <div class="col-xs-12" style="font-size: 15px;">就餐人数：<?php echo ($oinfo["EatingNums"]); ?></div>
        <?php if($oinfo['TableId']): ?><div class="col-xs-12" style="font-size: 15px;"><b>桌号：<?php echo ($oinfo["TableId"]); ?></b></div><?php endif; ?>
        ...
        <table class="table table-bordered">
        	<tr>
        		<td style="font-size:5px;text-align:left;">菜品信息</td>
            <td style="font-size:5px;text-align:right;">数量</td>
          </tr>
          <?php if(is_array($pros)): foreach($pros as $key=>$pro): ?><tr>
            ...
            <td style="font-size:5px;text-align:right;"><?php echo ($pro["Count"]); ?></td>
          </tr><?php endforeach; endif; ?>
        <tr>
          <td style="text-align:left;">合计</td>
          <td style="text-align:right;"><?php echo ($allcount); ?></td>
        </tr>
      </table>
      <div style="width:100%;border-bottom:2px dotted #000;"></div>
