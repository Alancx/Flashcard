...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        $('.addcoupon').click(function(){
            window.location.href="<?php echo U('Activity/addCoupon');?>";
        })
        $('.showing').click(function(){
            ...
            art.dialog.confirm('确定要发布此优惠券吗？',function(){
                ...
                $.ajax({
                    url:"<?php echo U('Activity/setCoupon');?>",
                    type:"post",
        ...
        $('.editing').click(function(){
            window.location.href="<?php echo U('Activity/addCoupon');?>?id="+$(this).attr('data-id');
