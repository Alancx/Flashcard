...
<html lang="zh-CN">
  ...
  <body>
  <?php if($imgurl == ''): ?><form action="<?php echo U('Upimg/spceil');?>" method="post" enctype="multipart/form-data">
    <table class="table">
    	<tr>
    ...
    function load(){
        ...
        var cdom=origin.document.getElementById(domid+"_c");
        cdom.setAttribute('class','form-group has-success');
    }
    if (statu) {
    	load();
    };
