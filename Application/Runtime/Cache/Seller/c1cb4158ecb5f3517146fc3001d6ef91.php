...
<html lang="zh-CN">
  ...
  <body>
  <?php if($imgurl == ''): ?><form action="<?php echo U('Upimg/index');?>" method="post" enctype="multipart/form-data">
    <table class="table">
        <tr>
    ...
    function load(){
        ...
        var cdom=origin.document.getElementById(domid+"_url");
        // console.log(cdom);
        var img_url="/web"+statu;
        console.log(img_url);
        cdom.setAttribute('src',img_url);
    }
    if (statu) {
        load();
    };
