    ...
    <div class="col-lg-9">
        <div class="ibox float-e-margins">
            <div class="ibox-title">
                <h5>商品信息<small class="text-info">只显示当前库存大于0的商品规格明细信息</small></h5>
                <div class="ibox-tools">
                    <a class="collapse-card">
                        <i class="fa fa-chevron-up" id="OutWarehouseId"><?php echo ($OutWarehouseId); ?></i>
                    </a>
                </div>
            </div>
...
<script src="/Public/Admin/Admin/common/js/showOutWarehouseProdialog.js"></script>
</body>
</html>