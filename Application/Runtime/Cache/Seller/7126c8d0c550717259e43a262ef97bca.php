...
<head lang="en">
    ...
    <script>
        var bindinfo={
            postUrl:"<?php echo U('Invoicing/inventory');?>",
            stimeEmpty:"开始日期不能为空!",
            etimeEmpty:"结束日期不能为空!",
    ...
    <div class="col-lg-9">
        <div class="ibox float-e-margins">
            <div class="ibox-content">
                <form role="form" class="form-inline" method="post" action="<?php echo U('Invoicing/showInventoryDraft');?>" id="formselect">
                ...
                <table class="table table-striped table-hover">
                    ...
                    <tbody id="ProSpectbody">
                       <?php if(is_array($data)): foreach($data as $k=>$vo): ?><tr>
                                <td><?php echo ($k+1); ?></td>
                                <td><a class="href-data"><?php echo ($vo["InventoryId"]); ?></a></td>
