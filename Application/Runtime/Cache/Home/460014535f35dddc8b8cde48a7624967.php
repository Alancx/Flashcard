...
<body>
  <div class="container">
<link rel="stylesheet" type="text/css" href="/Public/newhome/css/myshops.css?v=1.1" />
<div class="shoplist">
  <p style="text-align: center; margin-top: 10px; font-size: 12px;">我关注的店铺，左滑可以取消关注。</p>
  <ul class="mui-table-view">
    <?php if(is_array($shopinfo)): foreach($shopinfo as $key=>$vo): ?><li class=" mui-media  mui-table-view-cell " RPath="<?php echo U('Index/Index',array('once'=>'1','stoken'=>$vo['stoken']));?>">
        <a href="javascript:;" class="mui-slider-handle">
          <img class="mui-media-object mui-pull-left" src="<?php echo ($vo["Slogo"]); ?>">
          <div class="mui-media-body">
            <span><?php echo ($vo["storename"]); ?></span>
            <p class="mui-ellipsis"><?php echo ($vo["province"]); echo ($vo["city"]); echo ($vo["area"]); echo ($vo["addr"]); ?></p>
          </div>
        </a>
        <div class="mui-slider-right mui-disabled delebtn">
          <a class="mui-btn"><span class="setdelete" data-mcid="<?php echo ($vo["ID"]); ?>">取消关注</span></a>
        </div>
      </li><?php endforeach; endif; ?>
  </ul>
</div>
<script type="text/javascript">
  var setshopcollect_url = "<?php echo U('User/delusercollect');?>";
</script>
<script type="text/javascript" src="/Public/newhome/js/myshops.js?v=1.1"></script>
</div>
  <!-- footer-menus -->
