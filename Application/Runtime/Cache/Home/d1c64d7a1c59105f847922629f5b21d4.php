...
<body>
  <div class="container">
<link rel="stylesheet" type="text/css" href="/Public/newhome/css/mycollect.css?v=1.1" />
<div class="prolist">
  <p style="text-align: center; margin-top: 10px; font-size: 12px;">我收藏的美食，左滑可以取消收藏。</p>
  <ul class="mui-table-view total" >
    <?php if(is_array($proinfo)): foreach($proinfo as $key=>$vo): ?><li class=" mui-media  mui-table-view-cell ">
        <a href="javascript:;" class="mui-slider-handle" data-id="<?php echo ($vo["ProId"]); ?>">
          ...
          <div class="mui-media-body">
            ...
            <p><?php echo ($vo['storename']); ?></p>
            <span class="jiage"><?php echo ($vo['Price']); ?></span>
          </div>
        </a>
        <div class="mui-slider-right mui-disabled delebtn" data-oo="<?php echo ($vo["ID"]); ?>">
          <a class="mui-btn cancle">
            <span class="setdelete" data-mcid="<?php echo ($vo["ID"]); ?>">取消收藏</span>
          </a>
        </div>
...
<script type="text/javascript" src="/Public/newhome/js/mycollect.js?v=1.1"></script>
</div>
  <!-- footer-menus -->
