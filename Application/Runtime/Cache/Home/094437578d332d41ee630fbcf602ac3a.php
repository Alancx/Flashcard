...
<html>
		...
		<title>活动</title>
		<script src="/FlashCard/Public/js/mui.min.js"></script>
		<link href="/FlashCard/Public/css/mui.min.css" rel="stylesheet" />
...
<body>
		...
		<div class="img">
			<img src="/FlashCard/Public/img/banner1.jpg" />
		</div>
		<div class="zhong">
		<?php if(is_array($list)): foreach($list as $key=>$li): ?><div class="zhong-left"><img src="<?php echo ($li["ProLogoImg"]); ?>" />
				...
				<div class="price">
					<span>￥<?php echo ($li["Price"]); ?> </span><del>￥<?php echo ($li["PriceRange"]); ?></del>
				</div>
				...
				<ul class="content-ull">
					<li>
						<div class="content-img">
							<img src="/FlashCard/Public/img/spimg.jpg" />
						</div>
