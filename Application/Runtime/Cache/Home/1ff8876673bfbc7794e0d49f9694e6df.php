...
<body>
  <div class="container">
<link rel="stylesheet" type="text/css" href="/Public/newhome/css/myredpack.css?v=1.1" />
<div class="redpackpart">
  <div class="tit">
    <span style="color: #ff0000; float: left;"><span style="font-weight: bolder;margin-right: 20px;">领红包</span><span>少花钱</span></span>
    <img src="/Public/newhome/img/hongbao3.png" />
    <!-- <span class="mui-pull-right guize">使用规则</span> -->
  </div>

  <ul class="navt">
    <li class="checkli"><span>未使用</span></li>
    <li><span>已失效</span></li>
  </ul>

  <div class="" data-oo="item">
    <?php if(is_array($cinglist)): foreach($cinglist as $key=>$cli): ?><ul class="itembox">
        <li>
          <div class="">
            <img src="<?php echo ($cli["Slogo"]); ?>" class="dianlogo"/>
            <div class="mui-ellipsis"><?php echo ($cli["storename"]); ?></div>
            <small class="mui-icon mui-icon-arrowright"></small>
          </div>
          <p>有限期至<?php echo ($cli["edate"]); ?><span>(<?php echo ($cli["CouponCount"]); ?>个)</span></p>
        </li>
        <li>
          <img src="/Public/newhome/img/hongbao.png" height="40px"/>
          <span class="jine"><?php echo ($cli["Rules"]); ?></span>
        </li>
      </ul><?php endforeach; endif; ?>
    <!-- <ul class="itembox">
      <li>
        <div class="">
          <img src="/Public/newhome/img/spimg.jpg" class="dianlogo"/>
          <div class="mui-ellipsis">百乐川烤鱼百乐川烤鱼百乐川烤鱼</div>
          <small class="mui-icon mui-icon-arrowright"></small>
        </div>
        <p>有限期至2017.11.11 23:59:59</p>
      </li>
      <li>
        <img src="/Public/newhome/img/hongbao.png" height="40px"/>
        <span class="jine">5.0</span>
      </li>
    </ul>
    <ul class="itembox">
      <li>
  ...
  <div class="" data-oo="item" hidden="">
    <?php if(is_array($cendlist)): foreach($cendlist as $key=>$cli): ?><ul class="itembox">
        <li>
          <div class="">
            <img src="<?php echo ($cli["Slogo"]); ?>" class="dianlogo"/>
            <div class="mui-ellipsis"><?php echo ($cli["storename"]); ?></div>
...
<script src="/Public/newhome/js/myredpack.js?v=1.0" type="text/javascript" charset="utf-8"></script>
</div>
  <!-- footer-menus -->
