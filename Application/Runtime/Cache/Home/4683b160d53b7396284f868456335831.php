  ...
  <div class="allproinfo">
    <div class="contentstop">
      ...
      <div class="redinfopart">
        <img src="/Public/newhome/img/showredimg.png" alt="">
      </div>
      <!--红包部分-->
      ...
      <div class="activitypart">
        <div class="activitypart_1" RPath="<?php echo U('Index/activity',array('type'=>TJ));?>">
          <!-- <?php if(empty($showname["tjshowname"])): ?><span>特价</span>
    				<?php else: ?>
            <span><?php echo ($showname["tjshowname"]); ?></span><?php endif; ?> -->
        ...
        <div class="activitypart_2" RPath="<?php echo U('Index/activity',array('type'=>TS));?>">
          <!-- <?php if(empty($showname["tsshowname"])): ?><span>特色</span>
    				<?php else: ?>
            <span><?php echo ($showname["tsshowname"]); ?></span><?php endif; ?> -->
    ...
    <div class="tabpart">
      <ul id="tab_part">
        ...
        <li data-index='1'><span><span>评价(<?php echo ($sevalnum); ?>)</span></span><span class="tab_line"></span></li>
          ...
          <ul>
            <?php if(is_array($allpros)): foreach($allpros as $key=>$pro): ?><li>
                ...
                <?php if(is_array($pro["pros"])): foreach($pro["pros"] as $key=>$po): if($po['plcount'] > 1 ): ?><div class="spitem outproinfo" data-pid="<?php echo ($po["ProId"]); ?>" data-cid="<?php echo ($pro["ClassId"]); ?>">
                      ...
                      <?php if($po['Level'] != ''): ?><span class="eatmore">越来越便宜</span><?php endif; ?>
                    </div>
                  <?php else: ?>
              ...
              <div class="righteval">
                <span class="userinfo">
                  ...
                  <span class="setstarts">
                    <?php $__FOR_START_19459__=1;$__FOR_END_19459__=6;for($i=$__FOR_START_19459__;$i < $__FOR_END_19459__;$i+=1){ if($sv['ServiceScore'] >= $i): ?><span class="ggg xing_icon setstartactive"></span>
                        <?php else: ?>
