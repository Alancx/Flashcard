...
<link rel="stylesheet" href="/Public/Sellermobile/CSS/districash.css?v=1.0">
<div class="partdis">
  <div class="parttop">
    <label class="seltopactive" data-type="1">待审核<span></span></label>
    <label data-type="2">已审核<span></span></label>
    <label data-type="3">已完成<span></span></label>
    <label data-type="4">已拒绝<span></span></label>
  </div>
  <div class="partcontents">
    ...
    <div class="discashlist">
      <div class="districash_list_1">
        <?php if(is_array($dshdata)): foreach($dshdata as $key=>$info): ?><div class="part_list">
            <label><?php echo ($info['CDate']); ?><br><?php echo ($info['Ctime']); ?></label>
            <label><?php echo ($info['TrueName']); ?></label>
            <label><?php echo ($info['Money']); ?></label>
            <label data-id="<?php echo ($info['ID']); ?>"><span onclick="agreeclick(this)">同意</span><span onclick="refuseclick(this)">拒绝</span></label>
          </div><?php endforeach; endif; ?>
      </div>
      <div class="districash_list_2">
        <?php if(is_array($yshdata)): foreach($yshdata as $key=>$info): ?><div class="part_list">
            <label><?php echo ($info['CDate']); ?><br><?php echo ($info['Ctime']); ?></label>
            <label><?php echo ($info['TrueName']); ?></label>
            <label><?php echo ($info['Money']); ?></label>
            <label>已审核</label>
      ...
      <div class="districash_list_3">
        <?php if(is_array($ywcdata)): foreach($ywcdata as $key=>$info): ?><div class="part_list">
            <label><?php echo ($info['CDate']); ?><br><?php echo ($info['Ctime']); ?></label>
            <label><?php echo ($info['TrueName']); ?></label>
            <label><?php echo ($info['Money']); ?></label>
            <label>已完成</label>
      ...
      <div class="districash_list_4">
        <?php if(is_array($yjjdata)): foreach($yjjdata as $key=>$info): ?><div class="part_list">
            <label><?php echo ($info['CDate']); ?><br><?php echo ($info['Ctime']); ?></label>
            <label><?php echo ($info['TrueName']); ?></label>
            <label><?php echo ($info['Money']); ?></label>
            <label>已拒绝</label>
...
<script type="text/javascript">
  var setpscheckurl="<?php echo U('User/setpscheck');?>";
</script>
<script src="/Public/Sellermobile/JS/districash.js?v=1.0" charset="utf-8"></script>
