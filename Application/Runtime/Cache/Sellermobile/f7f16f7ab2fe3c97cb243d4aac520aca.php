...
<link rel="stylesheet" href="/Public/Sellermobile/css/list.css">
<script src="/Public/Sellermobile/js/base.js"></script>
<!-- <script scr="/Public/Sellermobile/js/.css"></script> -->
	<div class="top">多吃优惠商品列表  <a style="color:#000000;" href="<?php echo U('Cheap/edit',array('ProId'=>'add'));?>">十</a></b></div>
	<?php if(is_array($list)): foreach($list as $key=>$row): ?><div class="zhong">
		<div class="img"><img src="<?php echo ($row['ProLogoImg']); ?>" /></div>
		<div class="text"><span><?php echo ($row['ProName']); ?></span></div>
		<div class="price"><span>
		<?php $__FOR_START_22885__=1;$__FOR_END_22885__=$row['Level']+1;for($i=$__FOR_START_22885__;$i < $__FOR_END_22885__;$i+=1){ ?>￥<?php echo $row['Lv'.$i]; ?>/<?php } ?>
		</span>

		</div>
		<div class="right">
			<a href="<?php echo U('Cheap/edit',array('ProId'=>$row['ProId']));?>" style="color:#000000; height:40px;line-height:40px;">编辑</a>&nbsp&nbsp&nbsp&nbsp&nbsp<a style="color:#000000; height:40px;line-height:40px;" data-id="<?php echo ($row['ProId']); ?>" class="delete">删除</a>
		</div>
