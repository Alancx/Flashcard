...
<div class="tableinfo">
  ...
  <div class="tablelist">
    <ul>
      <?php if(is_array($rinfo)): foreach($rinfo as $key=>$tl): ?><li class="table_info" data-id="<?php echo ($tl['ID']); ?>" data-content="<?php echo ($tl['content']); ?>">
        <span class="tablename"><?php echo ($tl['content']); ?><span></span></span>
