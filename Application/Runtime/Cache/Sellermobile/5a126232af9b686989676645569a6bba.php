...
<link rel="stylesheet" href="/Public/Sellermobile/css/sqWarehouse.css?v=1.0">
...
<div class="allconternts">
  <div class="part part_top">
    ...
    <div class="orderinfo">
      <div class="infoitem">
        <label>系统单号:</label><span><?php echo ($warhouse['InWarehouseId']); ?></span>
      </div>
      <div class="infoitem">
        <label>订货仓库:</label><span><?php echo ($warhouse['InStorehouseName']); ?></span>
      </div>
      <div class="infoitem">
        <label>订货人员:</label><span><?php echo ($warhouse['InputName']); ?></span>
      </div>
      <div class="infoitem">
        <label class="odate">订货日期:</label><span><?php echo ($warhouse['oDate']); ?></span>
      </div>
      <div class="infoitem">
  ...
  <div class="part pro_list">
    <label class="proinfo">订货商品</label>
  </div>
  <div class="prolist">
    <?php if(is_array($warhouselist)): foreach($warhouselist as $key=>$litem): ?><div class="proitem">
        ...
        <div class="pcontent">
          ...
          <label class="pprice">售价:<span>￥<?php echo $litem['Price']?sprintf("%.2f",$litem['Price']):'0.00' ?></span>&emsp;进价:<span>￥<?php echo $litem['cosp']?sprintf("%.2f",$litem['cosp']):'0.00' ?></span>&emsp;数量:<span><?php echo ($litem['Count']); ?></span></label>
        </div>
      </div><?php endforeach; endif; ?>
  </div>
<script type="text/javascript">
$('.prolist').css('height',$('.allconternts').height()-$('.part_top').outerHeight()-$('.pro_list').outerHeight()+'px');
$('.proitem>.pcontent').css('right','10px');
</script>
