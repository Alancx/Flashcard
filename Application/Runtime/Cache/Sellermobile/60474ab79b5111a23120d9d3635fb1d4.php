...
<link rel="stylesheet" href="/Public/Sellermobile/css/shopsetinfo.css?v=1.0">
<script type="text/javascript">
var shopimagesave= "<?php echo U('User/shopimage');?>";//图片保存地址
var shopimgurl ="<?php echo U('User/shopimagesave');?>";
</script>
<div class="showshopimgspart">
  <div class="shopimgslist">    
    <?php if(is_array($shopimgs)): foreach($shopimgs as $key=>$vo): ?><img src="<?php echo ($vo); ?>" class="imglist"><?php endforeach; endif; ?>
    <div class="addbtn">
      <img src="/Public/Sellermobile/icon/addimg.png" id="addimg">
      <input type="file"  id="selswimg" name="selimg" onchange="selsimage(this)">
    </div>
  </div>
  <div class="savebtn">
    <span>保 存</span>
...
<script type="text/javascript" src="/Public/Sellermobile/js/shopsetinfo.js?v=1.0"></script>
