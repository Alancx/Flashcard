...
<link rel="stylesheet" href="/Public/Sellermobile/css/xuanzetese.css?v=1.0">
<script src="/Public/Sellermobile/js/base.js"></script>
	<div class="content">
		<?php if(is_array($list)): foreach($list as $key=>$row): ?><div class="theme" data-id="<?php echo ($row['ProId']); ?>" data-price="<?php echo ($row['Proce']); ?>">
			<div class="shang">
	...
	$(document).on('click','.right',function(){
		...
		$.each($('.theme'),function(index,item){
			if($(item).find('.tap').length>0){
				senddata['id']=$(item).attr('data-id');
				// senddata['price']=$(item).attr('data-price');
			}
