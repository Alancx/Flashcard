...
<link rel="stylesheet" href="/Public/Sellermobile/css/prolist.css?v=1.0">
<style>
.nodata{
  display: block;
...
<?php if(empty($plist)): ?><div class="nodata">
    <img src="/Public/Sellermobile/icon/watermark.png" alt="">
  </div>
  <?php else: ?>
  <?php if(is_array($plist)): foreach($plist as $key=>$item): ?><div class="proinfo P_<?php echo ($item['ProId']); ?>" data-pid="<?php echo ($item['ProId']); ?>">
      ...
      <div>
        ...
        <label class="pcount">当前库存: <?php echo $item['PCount']?sprintf("%.0f",$item['PCount']):'0' ?></label>
      </div>
