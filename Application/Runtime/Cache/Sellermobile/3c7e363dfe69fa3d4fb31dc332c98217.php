...
<link rel="stylesheet" href="/Public/Sellermobile/css/whmage.css">
<div class="whhouse">
	<div class="whinhouse"><a href="<?php echo U('UMWareHouse/inWarehouse');?>"><label>入库单</label></a></div>
	<!-- <div class="whouthouse"><a href="<?php echo U('UMWareHouse/outWarehouse');?>"><label>出库单</label></a></div> -->
	<div class="whouthouse"><a href="<?php echo U('UMWareHouse/sqWarehouselist');?>"><label>订货申请单</label></a></div>
</div>
