...
<link rel="stylesheet" href="/Public/Sellermobile/css/settable.css?v=1.0">
<div class="tableinfo">
  <div class="toptitle">
    <span>桌号设置</span>
  </div>
  ...
  <div class="tablelist">
    <ul>
      <?php if(is_array($tinfo)): foreach($tinfo as $key=>$tl): ?><li class="table_info" data-id="<?php echo ($tl['ID']); ?>" data-tname="<?php echo ($tl['Tname']); ?>">
        <span class="tablename"><?php echo ($tl['Tname']); ?>号<span>点击查看二维码</span></span>
  ...
  <div class="showcodemark">
    ...
    <img class="closecodeinfo" src="/Public/Sellermobile/icon/guanbi.png" alt="">
  </div>
</div>
...
<script type="text/javascript">
  ...
  function setbtninfo(){
    ...
    $('.tablename').click(function(){
      ...
      $(".codeinfo").attr('src',"<?php echo U('Public/getQr');?>?id="+id+"");
