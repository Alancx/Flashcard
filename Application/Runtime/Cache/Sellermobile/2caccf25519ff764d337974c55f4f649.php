...
<link rel="stylesheet" href="/Public/Sellermobile/css/jieshao.css">
	<div class="logo logs" style="padding-left:10px;">头像<img src="<?php echo ($list['Slogo']); ?>"><input type="file" id="log" name="files" onchange="logoupload(this)"></div>
	<div class="logo" style="padding-left:10px;">店铺名称<span><?php echo ($list['storename']); ?></span></div>
	<div class="logo" style="padding-left:10px; display:none;">店铺信息<span><?php echo ($list['Descinfo']); ?></span></div>
	<div class="logo" style="padding-left:10px;">店铺地址<span><?php echo ($list['addr']); ?></span></div>
<script src="/Public/Sellermobile/js/ajaxfileupload.js"></script>
<script>
	...
	function uploads(){
		var htmls='';
		$.ajaxFileUpload({
			url:"<?php echo U('User/logo');?>", //用于文件上传的服务器端请求地址
			type:"post",
