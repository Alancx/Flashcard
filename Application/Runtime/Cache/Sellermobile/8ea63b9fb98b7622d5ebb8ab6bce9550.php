...
<link rel="stylesheet" href="/Public/Sellermobile/css/revenue.css?v=1.2">
<script type="text/javascript" src="/Public/Sellermobile/js/echarts.common.min.js"></script>
<script type="text/javascript" src="/Public/Sellermobile/js/revenue.js"></script>
<style type="text/css">
...
<div class="reheard">
  ...
  <div class="reheard-2">
    <div>
      <label>￥<?php echo $sdrevenue?sprintf("%.2f",$sdrevenue):'0.00' ?><br><span>七天收入</span></label>
    </div>
    <div>
      <label>￥<?php echo $maxev?sprintf("%.2f",$maxev):'0.00' ?><br><span>单日最高</span></label>
    </div>
    <div>
      <label>￥<?php echo $sdrevenue?sprintf("%.2f",$sdrevenue/7):'0.00' ?><br><span>日均</span></label>
    </div>
  </div>
</div>
...
<table class="table table-bordered">
  ...
  <tbody>
  <?php if(is_array($table_data)): foreach($table_data as $key=>$tb): ?><tr>
      <td><?php echo ($tb["PayDate"]); ?></td>
      <td><?php echo ($tb["money"]); ?></td>
...
var dayven_url="<?php echo U('Record/seldayven');?>"; //加载所选日期的营业
</script>
