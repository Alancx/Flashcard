...
$(document).ready(function () {
  ...
  funlist['more_1']('-1');
  //固定左侧和右侧高度
  $('.rightorders').css('height',$(window).height()-80+"px");
   $('#tagsel>li').css('width',($(window).width()-10)/6+"px");
})
  ...
  $.ajax({
    ...
    success:function(msg){
      if (msg.status == 'true') {
        ...
        for (var key in data){
          htmls+='<div class="orderinfo">'+
           '<label class="orderid">'+data[key].MemberName+'<span>待发货</span>'+
           '<br><span>'+data[key].OrderId+'</span><span>'+(data[key].oDate).substring(5)+
           '</span></label><div class="prolist">';
           var datapro=data[key].prolist;
           for (var pkey in datapro) {
  ...
  $.ajax({
    ...
    success:function(msg){
      if (msg.status == 'true') {
        ...
        for (var key in data){
          htmls+='<div class="orderinfo">'+
           '<label class="orderid">'+data[key].MemberName+'<span>已发货</span>'+
           '<br><span>'+data[key].OrderId+'</span><span>'+(data[key].oDate).substring(5)+
           '</span></label><div class="prolist">';
           var datapro=data[key].prolist;
           for (var pkey in datapro) {
  ...
  $.ajax({
    ...
    success:function(msg){
      if (msg.status == 'true') {
        ...
        for (var key in data){
          htmls+='<div class="orderinfo">'+
           '<label class="orderid">'+data[key].MemberName+'<span>待提货</span>'+
           '<br><span>'+data[key].OrderId+'</span><span>'+(data[key].oDate).substring(5)+
           '</span></label><div class="prolist">';
           var datapro=data[key].prolist;
           for (var pkey in datapro) {
  ...
  $.ajax({
    ...
    success:function(msg){
      if (msg.status == 'true') {
        ...
        for (var key in data){
          htmls+='<div class="orderinfo">'+
           '<label class="orderid">'+data[key].MemberName+'<span>已关闭</span>'+
           '<br><span>'+data[key].OrderId+'</span><span>'+(data[key].oDate).substring(5)+
           '</span></label><div class="prolist">';
           var datapro=data[key].prolist;
           for (var pkey in datapro) {
