                ...
                $(proinfo.data).each(function(index, val) {
                    ...
                    if (_id == val.id && $.inArray(val.card, _parAttr) == -1) {
                        ...
                        if (parseInt(val.num)<=0) {
                            ProSpectbody.append('<tr><td><input type="checkbox" disabled="true" value="' + val.card + '" name="proAttr"/></td><td>' + val.incard + '</td><td>' + val.spec + '</td><td>' + val.num + '</td><td><input type="text" class="form-control form-inline input-innum" style="width:80px;" value="1"/><small class="text-danger"></small></td><td><div class="input-group" style="display:inline-table;width: 115px;"><span class="input-group-addon">¥</span><input type="text" class="form-control input-price" value="0" style="width:80px;"></div><small class="text-danger"><br/></small></td><td><small  class="text-danger">库存不足</small></td></tr>');
                        }else{
                            ProSpectbody.append('<tr><td><input type="checkbox" value="' + val.card + '" name="proAttr"/></td><td>' + val.incard + '</td><td>' + val.spec + '</td><td>' + val.num + '</td><td><input type="text" class="form-control form-inline input-innum" style="width:80px;" value=""/><small class="text-danger"></small></td><td><div class="input-group" style="display:inline-table;width: 115px;"><span class="input-group-addon">¥</span><input type="text" class="form-control input-price" value="0" style="width:80px;"></div><small class="text-danger"><br/></small></td></tr>');
                        }
                    }
                });
            }
    ...
    btnOk.bind("click", function() {
        ...
        if (InWarehouseId != "") {
            ...
            data = {
                ...
                "number":$.trim($("#InWarehouseNumber", parent.window.document).val()),
                "proid": pro_id,
                "classid": $.trim(ProClass.val()),
                "attr": attr,
            ...
            success: function(data) {
                ...
                if (data.code == "0") {
                    ...
                    $(dataList).each(function(index, val) {
                        inwarehouselist.append('<tr><td><input type="checkbox" value="' + val.card + '"></td><td>' + val.class.replace("---", "") + '</td><td>' + val.proName + '</td><td>' + val.inputcard + '</td><td>' + val.attrName + '</td><td>' + val.innum + '</td><td>' + val.price + '</td><td>' + parseFloat(val.innum) * parseFloat(val.price) + '</td></tr>');
                    });
                } else {
