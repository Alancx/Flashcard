$.fn.ProvinceCity = function (provinceid, cityid, districtid, public) {
    var _self = this;
    //定义3个默认值
    ...
    //插入3个空的下拉框
    _self.append("<select id=\"" + provinceid + "\" " + public + "></select>");
    _self.append("<select id=\"" + cityid + "\" " + public + "></select>");
    _self.append("<select id=\"" + districtid + "\" " + public + "></select>");
    //分别获取3个下拉框
